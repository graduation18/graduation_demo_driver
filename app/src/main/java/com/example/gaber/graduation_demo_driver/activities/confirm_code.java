...
public class confirm_code extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState)
    {
        ...
        signed_in=getIntent().getBooleanExtra("signed_in",false);
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()){
                            getSharedPreferences("logged_in",MODE_PRIVATE).edit()
                                    ...
                                    .commit();
                            if (signed_in){
                                Intent intent=new Intent(confirm_code.this,Mainview.class);
                                startActivity(intent);
                                finish();
                            }else {
                                Intent intent=new Intent(confirm_code.this,sign_up.class);
