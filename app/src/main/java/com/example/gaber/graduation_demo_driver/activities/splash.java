...
import com.example.gaber.graduation_demo_driver.custom.AppStatus;
...
public class splash extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.w("dsnjsadjlk", FirebaseInstanceId.getInstance().getToken());
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                if(getSharedPreferences("logged_in",MODE_PRIVATE).getBoolean("state",false)){
                    Intent main=new Intent(splash.this,Mainview.class);
                    startActivity(main);
                    finish();
